        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <button type="button" class="btn btn-success btn-sm float-right" data-toggle="modal" data-target="#tambahModal">Tambah</button>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                            ...
                            @foreach ($pinjaman as $data)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/Pinjaman/Edit/{{ $data->id_pinjaman }}" class="btn btn-warning btn-sm">
                                            <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <button class="btn btn-danger btn-sm btn-hapus" data-toggle="modal" data-target="#konfirmasiModal" data-id="{{ $data->id_pinjaman }}">
            ...
            <form action="/Pinjaman/Insert/" method="POST">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="judul_buku" class="form-control" id="judul_buku" value="{{ old('judul_buku') }}">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_peminjam" class="form-control" id="nama_peminjam" value="{{ old('nama_peminjam') }}">
                                <div class="text-danger">
                                    @error('nama_peminjam')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tgl_peminjam" class="form-control" id="tgl_peminjam" value="{{ old('tgl_peminjam') }}">
                        <div class="text-danger">
                            @error('tgl_peminjam')
                                {{ $message }}
                            @enderror
